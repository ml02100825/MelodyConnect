...
public class AdminBadgeController {
    ...
    public ResponseEntity<?> getBadges(
            ...
            @RequestParam(required = false) String acquisitionCondition,
        ...
        try {
            return ResponseEntity.ok(
                    adminBadgeService.getBadges(
                            page, size, idSearch, badgeName, acquisitionCondition, mode, isActive,
                            createdFrom, createdTo, sortDirection));
        } catch (Exception e) {
